...
namespace TestNew.Domain.Entities
{
    public class Flight
    {
        ...
        public object? CancelBooking(string passengerEmail, byte numberOfSeat)
        {
            var booking = Bookings.FirstOrDefault(b=>numberOfSeat == b.NumberOfSeats
